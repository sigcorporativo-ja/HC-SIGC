  ...
  render() {
    ...
    return (<HCForm onChange={onChange} model={model} validator={validator} inheritedClasses={{
      ...
      <FormInput type={showPassword
        ...
        }} name="password" onKeyPress={this.handleOnKeyPass} required={true} margin="normal" label={t('password')} fullWidth={true}/>
      <FormInput name="password_confirm" type="password" onChange={this.handlerOnConfirmPass} required={true} margin="normal" label={t('password_confirm')} fullWidth={true}/>
    </HCForm>);
  }
}
...
export default translate()(withStyles(styles, {withTheme: true})(EditInfo));
